                ...
                if(GlobalChannelToImageMapping.sharedInstance.GlobalChannelImageDict[archiveChanelId]!.count > totalCount){
                    if(totalCount < 10){
                        dispatch_async(dispatch_get_main_queue(), { () -> Void in
                            ...
                            self.customView = CustomInfiniteIndicator(frame: CGRectMake(self.photoThumpCollectionView.layer.frame.width - 50, self.photoThumpCollectionView.layer.frame.height/2 - 15, 30, 30))
